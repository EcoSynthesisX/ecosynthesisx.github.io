...
const FundingLive = () => (
  <>
    ...
    <span
      className="ml-4 px-4 py-1 rounded-full bg-teal-400 text-black font-bold shadow-lg animate-pulse flex items-center gap-2 whitespace-nowrap text-sm"
      style={{
...
export default function Home() {
  return (
    <div className="relative min-h-screen text-white flex flex-row bg-gradient-to-br from-[#232946] via-[#16161a] to-[#0f0f10]">
      ...
      {/* Header */}
        <header id="home" className="w-full max-w-3xl flex flex-col items-center gap-2 text-center">
          <div className="relative flex justify-center mb-4">
            <Image src={logoUrl} alt="EcoSynthesisX Logo" width={96} height={96} className="w-24 h-24 rounded-full border-4 border-teal-400 shadow-lg" />

          </div>
        <h1 className="text-4xl sm:text-5xl font-bold tracking-tight transform transition-transform duration-300 hover:scale-105 hover:translate-y-[-2px] hover:shadow-lg hover:shadow-teal-500/20">EcoSynthesisX</h1>
          <div className="flex gap-4 mt-2">
              <Link href="https://x.com/EcoSynthesisX" target="_blank" className="hover:underline">X</Link>
              <Link href="https://t.me/EcoSynthesisX" target="_blank" className="hover:underline">Telegram</Link>
              <Link href="https://discord.gg/EcoSynthesisX" target="_blank" className="hover:underline">Discord</Link>
            </div>
        ...
        <section className="max-w-5xl mx-auto my-4  rounded-2xl shadow-xl p-4 text-center">
        <h2 className="text-2xl sm:text-3xl font-bold mb-4">Who we are?</h2>
        <p className="mb-6 text-xl sm:text-2xl font-medium leading-relaxed">
      ...
      <section id="ESX" className="max-w-5xl mx-auto my-8 rounded-2xl shadow-xl p-8 text-center">

        <h2 className="text-2xl sm:text-3xl font-bold mb-4">
          What if you could help environment, empower communities,<br />and shape a better world?
        </h2>

        <p className="mb-1.4 text-lg sm:text-2xl py-5 pb-2">
          Contribute ETH to get <b>$ESX tokens</b> – tradable in the future and your way to vote on projects and unlock perks.
        </p>

        <h3 className="text-2xl sm:text-3xl font-bold mb-4 py-1">$ESX token</h3>
        <p className="mb-6 text-xl sm:text-2xl font-medium leading-relaxed">Finally, a crypto you can feel good about</p>
        <div className="flex flex-col sm:flex-row justify-center gap-8 mb-4">
          <div>
            <h4 className="font-bold text-grey-700 mb-1 sm:text-2xl">Decentralized Governance</h4>
            <p className="text-sm sm:text-xl">Vote for projects development and funds allocations</p>
          </div>
          <div>
            <h4 className="font-bold text-grey-700 mb-1 sm:text-2xl">Exchangeable</h4>
        ...
        <p className="mb-1.4 text-lg sm:text-3xl relative group">
          <span className="inline-block animate-pulse bg-gradient-to-r from-teal-400 to-blue-500 bg-clip-text text-transparent font-bold">
            Join our fundraising campaign on JuiceBox
          </span>
          <a 
            href="https://juicebox.money/v4/eth/76" 
            className="inline-block ml-2 text-teal-300 underline hover:text-teal-400 transition-colors duration-300 animate-bounce"
            target="_blank"
          >
        ...
        <p className="mt-4 sm:text-2xl">
          Become EcoSynthesisX stakeholder now! (<a href="https://juicebox.money/v4/eth/76" className="underline text-teal-300" target="_blank">link to JuiceBox</a>)
        </p>
        <p className="italic text-blue-200 mt-4.8 sm:text-3xl py-4">
      ...
      {/* Mission Section */}
        ...
        <section id="projects-in-development" className="w-full max-w-5xl mt-8 bg-gradient-to-br from-black/80 to-black-20 rounded-2xl shadow-2xl p-8">
          <h2 className="text-3xl font-bold mb-6 text-center">Projects In Development</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-8">
            {[
              ...
              <div key={project.name} className="bg-black/70 rounded-2xl shadow-2xl p-8 flex flex-col items-center text-center  animate-fade-in transition-all duration-300 hover:scale-105 hover:shadow-[0_8px_32px_0_rgba(0,255,255,0.25)] hover:border-teal-400 focus-within:scale-105 focus-within:shadow-[0_8px_32px_0_rgba(0,255,255,0.25)] focus-within:border-teal-400 cursor-pointer">

                <Image src={project.logo} alt={project.name + ' Logo'} width={96} height={96} className="w-32 h-32 rounded-full mb-4 border-4 border-teal-400 shadow-lg bg-white object-cover" />
                ...
                <div className="flex flex-wrap gap-4 mt-2 justify-center">
                  {[
                    {
                      key: 'website',
                      icon: <Image src="https://cdn-icons-png.flaticon.com/128/4305/4305021.png" alt="Website" width={24} height={24} className="invert" />,
                      ariaLabel: 'Website',
                    },
                    {
                      key: 'landingPage',
                      icon: <Image src="https://cdn-icons-png.flaticon.com/128/4305/4305021.png" alt="Landing Page" width={24} height={34} />,
                      ariaLabel: 'Landing Page',
                    },
                    {
                      key: 'karma',
                      icon: <Image src="https://github.com/show-karma/gap-app-v2/blob/dev/public/logo/karma-gap-logo.png?raw=true" alt="Landing Page" width={24} height={24}/>,
                      ariaLabel: 'Landing Page',
                    },
                    {
                      key: 'demo',
                      icon: <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z"/></svg>,
                      ariaLabel: 'Demo',
                    },
                    {
                      key: 'twitter',
                      icon: <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24"><path d="M24 4.557a9.93 9.93 0 0 1-2.828.775 4.932 4.932 0 0 0 2.165-2.724c-.951.564-2.005.974-3.127 1.195a4.92 4.92 0 0 0-8.384 4.482C7.691 8.095 4.066 6.13 1.64 3.161c-.542.929-.856 2.01-.857 3.17 0 2.188 1.115 4.117 2.823 5.254a4.904 4.904 0 0 1-2.229-.616c-.054 2.281 1.581 4.415 3.949 4.89a4.936 4.936 0 0 1-2.224.084c.627 1.956 2.444 3.377 4.6 3.417A9.867 9.867 0 0 1 0 21.543a13.94 13.94 0 0 0 7.548 2.209c9.058 0 14.009-7.496 14.009-13.986 0-.21 0-.423-.016-.634A9.936 9.936 0 0 0 24 4.557z"/></svg>,
                      ariaLabel: 'X / Twitter',
                    },
                    {
                      key: 'telegram',
                      icon: <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.477 2 2 6.477 2 12c0 5.523 4.477 10 10 10s10-4.477 10-10c0-5.523-4.477-10-10-10zm4.93 7.36l-1.43 6.77c-.11.48-.39.6-.78.37l-2.16-1.59-1.04 1c-.12.12-.23.23-.47.23l.17-2.38 4.34-3.92c.19-.17-.04-.27-.29-.1l-5.37 3.38-2.31-.72c-.5-.16-.51-.5.1-.73l9.02-3.48c.42-.16.79.1.65.7z"/></svg>,
                      ariaLabel: 'Telegram',
                    },
                    {
                      key: 'github',
                      icon: <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.477 2 2 6.477 2 12c0 4.418 2.867 8.166 6.839 9.489.5.092.682-.217.682-.483 0-.237-.009-.868-.014-1.703-2.782.604-3.369-1.342-3.369-1.342-.454-1.153-1.11-1.461-1.11-1.461-.908-.62.069-.608.069-.608 1.004.07 1.532 1.032 1.532 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.339-2.22-.253-4.555-1.112-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.269 2.75 1.025A9.564 9.564 0 0 1 12 6.844c.85.004 1.705.115 2.504.337 1.909-1.294 2.748-1.025 2.748-1.025.546 1.378.202 2.397.1 2.65.64.7 1.028 1.595 1.028 2.688 0 3.848-2.338 4.695-4.566 4.944.359.309.678.919.678 1.852 0 1.336-.012 2.415-.012 2.744 0 .268.18.579.688.481C19.135 20.163 22 16.418 22 12c0-5.523-4.477-10-10-10z"/></svg>,
                      ariaLabel: 'GitHub',
                    },
                    {
                      key: 'presentation',
                      icon: <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V5h14v14zM7 10h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg>,
        ...
        <section id="litepapers" className="w-full max-w-5xl mt-8 bg-gradient-to-br from-black/80 to-black-20 rounded-2xl shadow-2xl p-8">
          <h2 className="text-3xl font-bold mb-6 text-center">Future Projects</h2>
              ...
              <div key={project.name} className="bg-black/70 rounded-2xl shadow-2xl p-8 flex flex-col items-center text-center  animate-fade-in transition-all duration-300 hover:scale-105 hover:shadow-[0_8px_32px_0_rgba(0,255,255,0.25)] hover:border-teal-400 focus-within:scale-105 focus-within:shadow-[0_8px_32px_0_rgba(0,255,255,0.25)] focus-within:border-teal-400 cursor-pointer">
                ...
                <div className="flex flex-wrap gap-4 mt-2 justify-center">
                  {[
                    ...
                    {
                      key: 'landingPage',
                      icon: <Image src="https://cdn-icons-png.flaticon.com/128/4305/4305021.png" alt="Landing Page" width={24} height={24} className="invert" />,
                      ariaLabel: 'Landing Page',
                    },
                    {
                      key: 'demo',
          ...
          <section id="impact-products" className="w-full max-w-5xl mt-8 bg-gradient-to-br from-black/80 to-black/20 rounded-2xl shadow-2xl p-8">
          <h2 className="text-3xl font-bold mb-6 text-center">Impact Product Collection</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-8">
            {[
              {
                name: "Clean Phangan",
              ...
              <div key={project.name} className="bg-black/70 rounded-2xl shadow-2xl p-8 flex flex-col items-center text-center  animate-fade-in transition-all duration-300 hover:scale-105 hover:shadow-[0_8px_32px_0_rgba(0,255,255,0.25)] hover:border-teal-400 focus-within:scale-105 focus-within:shadow-[0_8px_32px_0_rgba(0,255,255,0.25)] focus-within:border-teal-400 cursor-pointer">
                ...
                <div className="flex flex-wrap gap-4 mt-2 justify-center">
                  {[
                    ...
                    {
                      key: 'karma',
                      icon: <Image src="https://github.com/show-karma/gap-app-v2/blob/dev/public/logo/karma-gap-logo.png" alt="Landing Page" width={24} height={24}/>,
                      ariaLabel: 'Landing Page',
                    },
                    {
                      key: 'demo',
        ...
        <section id="media" className="w-full max-w-5xl mt-8">
          <h2 className="text-3xl font-bold mb-6 text-center">Media & Socials</h2>

          {/* Videos */}
          <h3 id="Videos" className="text-2xl font-semibold mb-4"></h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            {interviews.filter(item => item.type === "video").map((item, idx) => (
              <div key={idx} className="bg-gradient-to-br from-blue/40 to-blue-900/80 rounded-xl shadow-lg p-6 flex flex-col gap-4">
          ...
          {/* Podcasts */}
          <h3 id="Podcasts" className="text-2xl font-semibold mb-4"></h3>
          <div className="grid grid-cols-1 gap-8 mb-8">
            {interviews.filter(item => item.type === "podcast").map((item, idx) => (
              <div key={idx} className="bg-gradient-to-br from-blue/40 to-blue-900/80 rounded-xl shadow-lg p-6 flex flex-col gap-4 max-w-2xl mx-auto">
                <div className="aspect-w-16 aspect-h-9 w-full rounded overflow-hidden mb-2">
                  <Image
          ...
          {/* Articles */}
          <h3 id="Articles" className="text-2xl font-semibold mb-4"></h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {interviews.filter(item => item.type === "article").map((item, idx) => (
              <div key={idx} className="bg-gradient-to-br from-blue/80 to-blue-900/20 rounded-xl shadow-lg p-6 flex flex-col gap-4">
                <h3 className="text-xl font-semibold mb-1">
                  <a href={item.url} target="_blank" rel="noopener noreferrer" className="hover:underline text-teal-200">
                    {item.title}
                  </a>
        ...
        {/* Backers Section */}
        <section id="backers" className="w-full max-w-6xl mx-auto mt-16 mb-12">
          <h2 className="text-3xl font-bold text-center mb-8">Our Backers</h2>
          <div className="relative rounded-2xl overflow-hidden" style={{background: 'linear-gradient(120deg, #232946 60%, #b2b2a6 100%)'}}>
            ...
            <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 p-8">
              {[
                ...
                <a key={backer.name} href={backer.url} target="_blank" rel="noopener noreferrer" className="bg-[#5a82a2] rounded-xl p-6 flex flex-col items-center justify-center shadow-lg hover:scale-105 hover:shadow-2xl transition-all duration-300 border-2 border-transparent hover:border-teal-400">
                  <Image src={backer.logo} alt={backer.name + ' logo'} width={64} height={64} className="mb-4" />
                  <span className="text-xl font-bold text-white font-backers text-center tracking-wide">{backer.name}</span>
                </a>
              ))}
        </div>
        </div>
